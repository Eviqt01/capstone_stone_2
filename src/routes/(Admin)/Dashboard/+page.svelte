...
<div class="relative min-h-screen">
	...
	<main class="relative flex min-h-screen flex-col gap-6 p-5">
		<div class="p-6">
			<div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
				...
				<div class="flex items-center gap-4 rounded-lg border bg-white p-6 shadow-sm">
					<div class="flex flex-1 flex-col gap-1">
						...
						<span class="text-2xl font-bold text-gray-900">₱45,678</span>
						<span class="flex items-center text-sm text-green-600">
							<span class="mr-1">↗️</span>
							+15% from last month
						</span>
		...
		<secion class="flex flex-wrap items-center justify-center gap-4">
			<div class="ml-auto bg-green-300 p-4">
				<h1>Sales Overview</h1>
			</div>
			<div class="mr-auto bg-blue-300 p-4">
				<h1>Recent Activity</h1>
			</div>
		</secion>
		<section class="bg-red-300 p-4">
			<h1>Recent Orders</h1>
		</section>
